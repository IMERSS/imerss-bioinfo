...
// This file was taken from revision 25fcb53 of https://github.com/EricSmekens/jsep/blob/master/src/jsep.js
// since we need the fix which axed "LogicalExpression" but need to defeat the insufferable ES6 modules crap
// which prevents it from loading. The "export" keyword was removed from the top of the file and a standard
// CJS export was put at the bottom. Probably when jsep 0.5.0 is released we can update to it
