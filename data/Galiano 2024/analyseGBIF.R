...
timedWrite(gbifNotColl, "Galiano_GBIF_Not_Coll_2023_11_15.csv")
timedWrite(gbifNotTrad, "Galiano_GBIF_Not_Trad_2023_11_15.csv")
timedWrite(gbifNotUnion, "Galiano_GBIF_Not_Union_2023_11_15.csv")
