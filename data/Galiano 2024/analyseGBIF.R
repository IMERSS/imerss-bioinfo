...
timedWrite(gbifNotColl, "Galiano_GBIF_Not_Coll_2023_09_25.csv")
timedWrite(gbifNotTrad, "Galiano_GBIF_Not_Trad_2023_09_25.csv")
timedWrite(gbifNotUnion, "Galiano_GBIF_Not_Union_2023_09_25.csv")
