...
hortis.renderSpeciesName = function (name) {
    return name.replace(hortis.annoteRegex, "<span class=\"checklist-rank\">$1</span>");
};

jqUnit.test("Styling of annotation", function () {
    const fixture = "Symphyotrichum foliaceum var. foliaceum";
    const expected = "Symphyotrichum foliaceum <span class=\"checklist-rank\">var.</span> foliaceum";
